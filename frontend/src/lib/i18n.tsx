...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "cacheDemo.title": "Open the last cached demo",
    "cacheDemo.subtitle": "Skip generation and show the completed University of Tokyo route immediately.",
  ...
  es: {
    ...
    "cacheDemo.title": "Abrir demo en cache",
    "cacheDemo.subtitle": "Saltar la generacion y ver al instante la ruta completada de la Universidad de Tokio.",
  ...
  zh: {
    ...
    "top.imagesOn": "图片开启",
    "top.imagesOff": "图片关闭",
    "cacheDemo.title": "查看上次生成的缓存",
    "cacheDemo.subtitle": "不用重新生成，直接进入东京大学路线的完整可玩版本。",
    "language.label": "语言",
    "language.aria": "选择语言",

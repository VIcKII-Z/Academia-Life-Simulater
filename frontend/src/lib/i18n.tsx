...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "cacheDemo.subtitle": "Skip generation and open the latest completed study-abroad route immediately.",
  ...
  es: {
    ...
    "cacheDemo.subtitle": "Saltar la generacion y abrir al instante la ruta de estudios mas reciente.",
  ...
  zh: {
    ...
    "cacheDemo.subtitle": "不用重新生成，直接进入最近生成路线的完整可玩版本。",
    "language.label": "语言",
    "language.aria": "选择语言",
